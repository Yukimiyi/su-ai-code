...
public class ProjectDownloadServiceImpl implements ProjectDownloadService {
    ...
    public void downloadProject(String projectPath, String downloadFileName, HttpServletResponse response) {
        ...
        ThrowUtils.throwIf(!projectDir.exists() || !projectDir.isDirectory(), ErrorCode.NOT_FOUND_ERROR, "项目目录不存在");
        ThrowUtils.throwIf(!projectDir.isDirectory(), ErrorCode.NOT_FOUND_ERROR, "指定路径不是目录");
