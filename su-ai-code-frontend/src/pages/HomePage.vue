  ...
  <div id="homePage">
    <div class="container">
      ...
      <div class="hero-section">
        <h1 class="hero-title">『织梦星枢』</h1>
        <p class="hero-description">汇聚创想，生而应用</p>
      </div>
      ...
      <div class="quick-actions">
        <a-button
          ...
          @click="
            setPrompt(
              '打造一个高效的项目管理工具网站，面向小型团队或自由职业者。包含任务看板、日程日历、团队协作聊天、文件共享、通知提醒和个人工作台等功能。界面简洁直观，支持拖拽操作、多设备同步、权限管理和数据导出，强调高效与可视化。',
            )
          "
          >项目管理网站</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '构建一个本地生活服务信息平台，涵盖商家展示、服务分类、用户评价、预约下单、地图定位和促销活动推送。采用卡片式布局突出商家信息，支持关键词搜索、区域筛选、多端适配，并集成在线客服与用户收藏功能。',
            )
          "
          >生活服务平台</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个专注于健康与健身的社区型应用，包含训练计划、饮食记录、健康数据追踪、用户打卡、社区动态和专家问答板块。设计清新活力，支持图表可视化健康指标，用户可设定目标、分享成果，并参与挑战活动与排行榜。',
            )
          "
          >社区应用</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '设计一个极简风格的个人作品集网站，适用于前端开发者或创意程序员。包含项目展示、技术栈介绍、博客文章、开源贡献链接和联系表单。支持暗色/亮色主题切换、代码高亮展示、GitHub动态同步，并优化加载性能与SEO。',
            )
          "
          >个人作品集网站</a-button
        >
